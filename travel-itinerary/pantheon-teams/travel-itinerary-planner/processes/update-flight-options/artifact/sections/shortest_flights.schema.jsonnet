{
  ...
  "properties": {
    "flights": {
      "authoring_guidance": "Provide up to 5 flight options sorted by total duration from shortest to longest. Each must include all required fields.",
      "description_for_schema": "Array of flight options sorted by duration (shortest first). Maximum 5 items.",
      "items": {
      ...
      "maxItems": 5,
      "purpose": "Contains the flight options sorted by duration ascending, enabling users to compare time-efficient choices.",
      "type": "array"
    }
  }
}